...
defaultproperties
{
    ...
    Profiles(17)=(Id="Snape",DisplayName="Snape",GroupName="Adults",BodyMesh=SkeletalMesh'HPModels.skProfSnapeMesh',DrawScale=1.0,AnimationStrategy=1,CloakStrategy=0,WandBone="Bip01 R Hand",Opacity=1.0,bSelectable=True,AuditStatus="NEEDS EXTRA CHANNEL")
    Profiles(18)=(Id="Lockhart",DisplayName="Lockhart",GroupName="Adults",BodyMesh=SkeletalMesh'HPModels.skProfLockhartMesh',DrawScale=1.0,AnimationStrategy=1,CloakStrategy=0,WandBone="Bip01 R Hand",Opacity=1.0,bSelectable=True,AuditStatus="NEEDS EXTRA CHANNEL")
    Profiles(19)=(Id="Dumbledore",DisplayName="Dumbledore",GroupName="Adults",BodyMesh=SkeletalMesh'HPModels.skProfDumbledoreMesh',DrawScale=1.0,AnimationStrategy=1,CloakStrategy=0,WandBone="Bip01 R Hand",Opacity=1.0,bSelectable=True,AuditStatus="NEEDS EXTRA CHANNEL")
    Profiles(20)=(Id="McGonagall",DisplayName="McGonagall",GroupName="Adults",BodyMesh=SkeletalMesh'HPModels.skProfMcGonagallMesh',DrawScale=1.0,AnimationStrategy=1,CloakStrategy=0,WandBone="Bip01 R Hand",Opacity=1.0,bSelectable=True,AuditStatus="NEEDS EXTRA CHANNEL")
    ...
    Profiles(22)=(Id="Lucius",DisplayName="Lucius Malfoy",GroupName="Adults",BodyMesh=SkeletalMesh'HPModels.skLuciousMalfoyMesh',DrawScale=1.0,AnimationStrategy=1,CloakStrategy=0,WandBone="Bip01 R Hand",Opacity=1.0,bSelectable=True,AuditStatus="NEEDS EXTRA CHANNEL")
