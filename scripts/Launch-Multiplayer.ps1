...
param(
    ...
    [ValidateSet('None','Health','Lumos','Pickup','PickupNet','AIInspect','AICombat','MountRootB0','MountRootB1')][string]$RuntimeProbe = 'None',
...
if ($CapturedAuthorityDiagnostic -and ($Mode -ne 'Coop' -or $Role -ne 'Host' -or $mapName -ine 'Ch1Rictusempra' -or $TestStage -ne 'RictusempraLessonComplete' -or $RuntimeProbe -notin @('None','AIInspect','AICombat','MountRootB0','MountRootB1'))) {
...
if ($RuntimeProbe -in @('MountRootB0','MountRootB1') -and (!$FirstIntroPreflight -or $IntroFault -ne 'None')) {
    throw 'MountRootB0/B1 requires normal FirstIntroPreflight without an injected fault.'
}
