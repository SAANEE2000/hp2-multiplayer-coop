...
class VersusFreeLookContractTests(unittest.TestCase):
    ...
    def test_release_recenters_camera_without_rotating_pawn(self):
        ...
        self.assertIn("Cam.rDestRotation.Yaw = VersusFreeLookPawnRotation.Yaw;", self.new_source)
        self.assertIn("Cam.rCurrRotation.Yaw = VersusFreeLookPawnRotation.Yaw;", self.new_source)
